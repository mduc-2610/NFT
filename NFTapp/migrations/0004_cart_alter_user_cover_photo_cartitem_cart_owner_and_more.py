...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('NFTapp', '0003_remove_nftproduct_like_nftproduct_likes'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='cover_photo',
            field=models.ImageField(default='/static/images/generic/Acer_Wallpaper_02_3840x2400', upload_to='avatar/%Y/%m/%d/'),
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
